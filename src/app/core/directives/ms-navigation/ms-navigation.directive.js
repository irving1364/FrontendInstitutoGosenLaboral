(function ()
{
    ...
    /** @ngInject */
    function MsNavigationController($scope, msNavigationService, getMensajeNuevosService)
    {
        var vm = this;
        ...
        $scope.nivelAcceso = localStorage.getItem('nivelAcceso');
        $scope.idRol = localStorage.getItem('idRol');
        
        console.log($scope.nivelAcceso);
        // Data
        if ( $scope.root )
        {
