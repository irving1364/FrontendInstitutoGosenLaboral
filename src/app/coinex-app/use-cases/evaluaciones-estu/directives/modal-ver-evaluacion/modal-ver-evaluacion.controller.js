(function() {
	...
	angular
		...
		.controller('modalVerEvaluacionController', modalVerEvaluacionController);
	
	function modalVerEvaluacionController($scope, $mdDialog, $mdToast, locals,
											getArchivoEvaluaCodMaestroService
												) {
		...
		function init (){
			...
			getArchivoEvaluaCodMaestroService.handle($scope.command, success, peticionFailed);
		}
