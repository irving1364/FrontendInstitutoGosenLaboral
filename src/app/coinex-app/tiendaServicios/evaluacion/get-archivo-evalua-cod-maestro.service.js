(function() {
	...
	angular
		...
		.factory('getArchivoEvaluaCodMaestroService', getArchivoEvaluaCodMaestroService);

	function getArchivoEvaluaCodMaestroService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getArchivoEvaluaSinCodMaestro', data);
		},
