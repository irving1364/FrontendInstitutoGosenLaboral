(function() {
	...
	angular
		...
		.factory('getEvaluaCerradasAlumService', getEvaluaCerradasAlumService);

	function getEvaluaCerradasAlumService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getEvaluacionesCerradasAlumno', data);
		},
