(function() {
	...
	angular
		...
		.factory('getArchivoEvaluaMaestroService', getArchivoEvaluaMaestroService);

	function getArchivoEvaluaMaestroService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getArchivoEvaluaMaestro', data);
		},
