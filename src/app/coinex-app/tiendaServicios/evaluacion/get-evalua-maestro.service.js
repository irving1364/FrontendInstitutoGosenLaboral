(function() {
	...
	angular
		...
		.factory('getEvaluaMaestroService', getEvaluaMaestroService);

	function getEvaluaMaestroService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getEvaluacionMaestro', data);
		},
