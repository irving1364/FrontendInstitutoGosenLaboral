(function() {
	...
	angular
		...
		.factory('editarAuseTardaEvaluaService', editarAuseTardaEvaluaService);

	function editarAuseTardaEvaluaService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			var data = {	
				...
				cod:                command.cod,
				ausencia:           command.ausencia,
				tardanza: 			command.tardanza		
				
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'evaluacion/updateAuseTardaEvaEstu', data);
		},
