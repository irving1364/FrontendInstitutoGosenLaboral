(function() {
	...
	angular
		...
		.factory('getArchivoEvaluaCorreccionesMaestroService', getArchivoEvaluaCorreccionesMaestroService);
        
	function getArchivoEvaluaCorreccionesMaestroService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Evaluacion/getArchivoEvaluaCorreccionesMaestro', data);
		},
