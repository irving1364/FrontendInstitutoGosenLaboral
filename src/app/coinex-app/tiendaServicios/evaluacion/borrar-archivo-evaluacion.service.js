(function() {
	...
	angular
		...
		.factory('borrarArchivoEvaluacionService', borrarArchivoEvaluacionService);

	function borrarArchivoEvaluacionService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'evaluacion/deleteArchivoEvaluacion', data);
		},
