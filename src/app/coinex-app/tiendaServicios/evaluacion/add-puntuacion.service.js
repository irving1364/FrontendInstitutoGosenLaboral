(function() {
	...
	angular
		...
		.factory('addPuntuacionService', addPuntuacionService);

	function addPuntuacionService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			var data = {	
				...
				comentario_maestro: command.comentario_maestro,		
				
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'evaluacion/updateEvaluacionEstu', data);
		},
