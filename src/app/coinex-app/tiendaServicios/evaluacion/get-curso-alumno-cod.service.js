(function() {
	...
	angular
		...
		.factory('getCursoAlumnoCodService', getCursoAlumnoCodService);

	function getCursoAlumnoCodService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
            var data = {	
				...
				cod_alumno:         command.cod_alumno
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Alumno/getCursoAlumnoCod', data);
		},
