(function() {
	...
	angular
		...
		.factory('reiniciarUserService', reiniciarUserService);

	function reiniciarUserService($coinexHttp, $q, newAddressResponseFake) {
	...
	registroHandler.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'auth/reiniciarUsuario', data);
		},
