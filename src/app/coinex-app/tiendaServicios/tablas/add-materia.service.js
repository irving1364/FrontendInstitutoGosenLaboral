(function() {
	...
	angular
		...
		.factory('addMateriaService', addMateriaService);

	function addMateriaService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/addMateria', data);
		},
