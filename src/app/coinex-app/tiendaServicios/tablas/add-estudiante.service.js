(function() {
	...
	angular
		...
		.factory('addEstudianteService', addEstudianteService);

	function addEstudianteService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/addEstudiante', data);
		},
