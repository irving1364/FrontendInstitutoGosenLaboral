(function() {
	...
	angular
		...
		.factory('asignarMateriaEstudiantesService', asignarMateriaEstudiantesService);

	function asignarMateriaEstudiantesService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
            ...
            console.log(data);
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/asignarMateriaEstudiantes', data);
		},
