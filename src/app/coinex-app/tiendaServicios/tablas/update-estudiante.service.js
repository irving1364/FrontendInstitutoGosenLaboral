(function() {
	...
	angular
		...
		.factory('updateEstudianteService', updateEstudianteService);

	function updateEstudianteService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/updateEstudiante', data);
		},
