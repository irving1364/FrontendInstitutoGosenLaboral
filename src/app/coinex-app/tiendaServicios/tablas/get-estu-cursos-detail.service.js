(function() {
	...
	angular
		...
		.factory('getEstuCursosDetailService', getEstuCursosDetailService);

	function getEstuCursosDetailService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'Tabla/getEstuCursosDetail', data);
		},
