(function() {
	...
	angular
		...
		.factory('deleteMateriaAsignadaService', deleteMateriaAsignadaService);

	function deleteMateriaAsignadaService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/deleteMateriaAsginada', data);
		},
