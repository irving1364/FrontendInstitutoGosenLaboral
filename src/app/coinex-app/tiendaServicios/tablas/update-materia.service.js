(function() {
	...
	angular
		...
		.factory('updateMateriaService', updateMateriaService);

	function updateMateriaService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/updateMateria', data);
		},
