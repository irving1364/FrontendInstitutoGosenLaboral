(function() {
	...
	angular
		...
		.factory('addConsejerosService', addConsejerosService);

	function addConsejerosService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/addConsejero', data);
		},
