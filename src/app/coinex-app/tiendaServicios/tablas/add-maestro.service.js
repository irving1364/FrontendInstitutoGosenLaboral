(function() {
	...
	angular
		...
		.factory('addMaestroService', addMaestroService);

	function addMaestroService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/addMaestro', data);
		},
