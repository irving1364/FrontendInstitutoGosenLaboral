(function() {
	...
	angular
		...
		.factory('updateActivoService', updateActivoService);

	function updateActivoService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/updateActivo', data);
		},
