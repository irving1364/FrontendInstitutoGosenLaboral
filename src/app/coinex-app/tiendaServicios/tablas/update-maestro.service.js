(function() {
	...
	angular
		...
		.factory('updateMaestrosService', updateMaestrosService);

	function updateMaestrosService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/updateMaestro', data);
		},
