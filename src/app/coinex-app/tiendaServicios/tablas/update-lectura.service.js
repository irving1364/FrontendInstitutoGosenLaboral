(function() {
	...
	angular
		...
		.factory('updateLecturaService', updateLecturaService);

	function updateLecturaService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			var data = {	
				...
				lectura:   command.lectura,
				cod_anio:  command.cod
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/updateLectura', data);
		},
