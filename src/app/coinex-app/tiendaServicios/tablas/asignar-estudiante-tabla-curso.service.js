(function() {
	...
	angular
		...
		.factory('asignarEstudianteTablaCursoService', asignarEstudianteTablaCursoService);

	function asignarEstudianteTablaCursoService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/asignarEstudianteTablaCurso', data);
		},
