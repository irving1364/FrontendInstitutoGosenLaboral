(function() {
	...
	angular
		...
		.factory('updateCursoService', updateCursoService);

	function updateCursoService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/updateCurso', data);
		},
