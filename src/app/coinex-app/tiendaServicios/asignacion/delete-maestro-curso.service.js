(function() {
	...
	angular
		...
		.factory('deleteMaestroCursoService', deleteMaestroCursoService);

	function deleteMaestroCursoService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			var data = {	
				...
				cod_curso:   	 command.cod,
				cod_anio:        localStorage.getItem('cod_anio')
			};
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/deleteMaestroCurso', data);
		},
