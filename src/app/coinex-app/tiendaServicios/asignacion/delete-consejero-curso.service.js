(function() {
	...
	angular
		...
		.factory('deleteConsejeroCursoService', deleteConsejeroCursoService);

	function deleteConsejeroCursoService($coinexHttp, $q, newAddressResponseFake) {
	...
	Handlers.prototype = {
		...
		action: function(command, success, failed) {
			...
			return this.coinexHttp.http.post(localStorage.getItem("apiUrl") +'tabla/deleteConsejeroCurso', data);
		},
